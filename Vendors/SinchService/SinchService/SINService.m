...
@property (nonatomic, strong, readonly) SINSLazyVideoController *videoController;
...
- (instancetype)initWithConfig:(SINServiceConfig *)config {
  ...
  if (self) {
    ...
    _videoController = [[SINSLazyVideoController alloc] init];
...
- (void)logInUserWithId:(NSString *)userId {
  ...
  [_videoController setProxee:[client videoController]];
...
- (void)onClientWillTerminate:(id<SINClient>)client {
  if (client == self.client) {
    ...
    [_videoController setProxee:nil];
  }
}
