...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    ...
    if (section == 3) return ([Account count] > 1) ? 2 : 1;
...
//	if ((indexPath.section == 2) && (indexPath.row == 3)) return cellAutoSave;
	if ((indexPath.section == 2) && (indexPath.row == 1)) return cellWallpapers;
...
//	if ((indexPath.section == 4) && (indexPath.row == 1)) return cellSwitchAccount;
	...
	if ((indexPath.section == 3) && (indexPath.row == 1)) return cellLogoutAll;
	return nil;
}
...
//	if ((indexPath.section == 2) && (indexPath.row == 3)) [self actionAutoSave];
	if ((indexPath.section == 2) && (indexPath.row == 1)) [self actionWallpapers];
...
//	if ((indexPath.section == 4) && (indexPath.row == 1)) [self actionSwitchAccount];
	...
	if ((indexPath.section == 3) && (indexPath.row == 1)) [self actionLogoutAll];
}
